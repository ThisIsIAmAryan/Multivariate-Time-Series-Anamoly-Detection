@echo off
REM Setup script for the Anomaly Detection Frontend (Windows)
...
call npm install recharts lucide-react papaparse date-fns clsx

echo.
echo 🔧 Installing development dependencies...
call npm install --save-dev @types/papaparse
